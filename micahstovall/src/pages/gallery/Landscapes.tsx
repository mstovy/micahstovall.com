...
export default function Landscapes() {
  // Load all images in the landscapes folder using Vite import.meta.glob
  const modules = import.meta.glob("../../assets/images/landscapes/*.{jpg,jpeg,png,webp}", {
    eager: true,
    as: "url",
  }) as ImageMap
    ...
    <section className="mx-auto w-full max-w-7xl px-4 py-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        {images.map((src, i) => (
          ...
          >
            <img src={src} alt={`Landscapes ${i + 1}`} className="w-full h-48 object-cover transition-transform duration-300 hover:scale-105" />
